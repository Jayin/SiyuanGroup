...
public class CalendarUtils {
     ...
     * @param fromat 格式 ，请查看本工具类的常量TYPE_
     * @return 时间字符串
     */
		...
		if ("timeline".equals(fromat)) {
			...
			case 0:
				...
				if (tmp <= 1) {
					...
					sb.append("前").append(tmp).append("分钟");
				} else {
					sb.append("今日 ").append(pre.get(Calendar.HOUR_OF_DAY))
			...
			default:
				sb.append(pre.get(Calendar.MONTH) + 1).append("月")
						...
						.append(pre.get(Calendar.HOUR_OF_DAY)).append(":")
						.append(pre.get(Calendar.MINUTE));
				break;
			}
		}
